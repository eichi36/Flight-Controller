...
/* USER CODE BEGIN PV */
uint8_t *data = "Hello World from USB\r\n";
const uint16_t READ_ACCEL_ZOUTL = 0xC00;
const uint16_t READ_TEMP_DISCARD = 0x0000;
const uint16_t READ_TEMP_H = 0xC100;
const uint16_t READ_TEMP_L = 0xC200;
